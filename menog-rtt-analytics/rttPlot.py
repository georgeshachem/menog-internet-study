...
ax = sns.clustermap(sym_rtt_min_df, method='average', figsize=(8, 8), cmap="YlGnBu")
...
ax = sns.clustermap(sym_rtt_med_df, method='average', figsize=(8, 8), cmap="YlGnBu")
ax.ax_row_dendrogram.set_visible(False)
...
#ax = sns.heatmap(rtt_min_df, annot=True, fmt=".0f")
ax = sns.clustermap(asym_rtt_min_df, method='average', figsize=(8, 8), cmap="YlGnBu")
#ax.ax_row_dendrogram.set_visible(False)
...
#ax = sns.heatmap(rtt_med_df, annot=True, fmt=".0f")
ax = sns.clustermap(asym_rtt_med_df, method='average', figsize=(8, 8), cmap="YlGnBu")
ax.ax_row_dendrogram.set_visible(False)
